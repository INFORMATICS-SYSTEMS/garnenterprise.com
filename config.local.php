...
$config['db_name'] = 'garn_enterprise';
$config['db_user'] = 'garn_enterprise';
$config['db_password'] = 'Z1~bsv37R2m2!ne2';
...
$config['http_host'] = 'garnenterprise.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'garnenterprise.com';
$config['https_path'] = '';
