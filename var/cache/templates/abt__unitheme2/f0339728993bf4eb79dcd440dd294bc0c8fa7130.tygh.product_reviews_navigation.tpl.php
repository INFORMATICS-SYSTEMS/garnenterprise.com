<?php /* Smarty version Smarty-3.1.21, created on 2021-08-12 12:13:57
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_navigation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12153407356114e6555bb1a7-80036879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f0339728993bf4eb79dcd440dd294bc0c8fa7130' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_navigation.tpl',
      1 => 1627581750,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12153407356114e6555bb1a7-80036879',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6114e6555dce30_48699287',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6114e6555dce30_48699287')) {function content_6114e6555dce30_48699287($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
$_tmp1=ob_get_clean();?><?php echo htmlspecialchars(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp1."&selected_section=product_reviews#product_reviews"), ENT_QUOTES, 'UTF-8');?>
"
    ...
    <nav class="ty-product-review-reviews-navigation">
        ...
        <label class="ty-product-review-reviews-navigation__filter <?php if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?>ty-product-review-reviews-navigation__filter--active<?php }?>">
            ...
            <a id="product_review_with_images_link"
                href="<?php ob_start();
if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?><?php echo "0";?><?php } else { ?><?php echo "1";?><?php }
$_tmp2=ob_get_clean();?><?php echo htmlspecialchars(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp2."&selected_section=product_reviews#product_reviews"), ENT_QUOTES, 'UTF-8');?>
"
                class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                data-ca-target-id="pagination_contents_comments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_id']->value, ENT_QUOTES, 'UTF-8');?>
"
