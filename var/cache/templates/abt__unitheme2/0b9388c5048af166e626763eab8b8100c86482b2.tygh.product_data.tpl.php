<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 09:58:17
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:448694952610e2f09a86465-14390719%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b9388c5048af166e626763eab8b8100c86482b2' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/product_data.tpl',
      1 => 1627896562,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '448694952610e2f09a86465-14390719',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e2f09d9d737_78330005',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e2f09d9d737_78330005')) {function content_610e2f09d9d737_78330005($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('text_out_of_stock','sku','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','availability','items','on_backorder','in_stock','availability','availability','in_stock','on_backorder','availability','quantity','text_cart_min_qty','text_edp_product','text_out_of_stock','sku','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','availability','items','on_backorder','in_stock','availability','availability','in_stock','on_backorder','availability','quantity','text_cart_min_qty','text_edp_product'));
?>
...
" <?php echo smarty_function_live_edit(array('name'=>"product:product:".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'phrase'=>$_smarty_tpl->tpl_vars['product']->value['product']),$_smarty_tpl);?>
><?php }
echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['product'],160,"...",true);
if ($_smarty_tpl->tpl_vars['hide_links']->value) {?></strong><?php } else { ?></a><?php }?>
    <?php }?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sku_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['show_sku']->value) {?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:abt__sku")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:abt__sku"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
--></span>
        ...
        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:abt__sku"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
&nbsp;<?php }
echo $_smarty_tpl->getSubTemplate ("buttons/add_to_cart.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_id'=>$_smarty_tpl->tpl_vars['_but_id']->value,'but_name'=>"dispatch[checkout.add..".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])."]",'but_role'=>$_smarty_tpl->tpl_vars['but_role']->value,'block_width'=>$_smarty_tpl->tpl_vars['block_width']->value,'obj_id'=>$_smarty_tpl->tpl_vars['obj_id']->value,'product'=>$_smarty_tpl->tpl_vars['product']->value,'but_meta'=>$_smarty_tpl->tpl_vars['add_to_cart_meta']->value), 0);
...
if ($_smarty_tpl->tpl_vars['settings']->value['abt__ut2']['product_list'][$_smarty_tpl->tpl_vars['tmpl']->value]['show_amount'][$_smarty_tpl->tpl_vars['settings']->value['abt__device']]==smarty_modifier_enum("YesNo::NO")&&(!$_smarty_tpl->tpl_vars['product']->value['hide_stock_info']&&!(($_smarty_tpl->tpl_vars['product_amount']->value<=0||$_smarty_tpl->tpl_vars['product_amount']->value<$_smarty_tpl->tpl_vars['product']->value['min_qty'])&&($_smarty_tpl->tpl_vars['product']->value['avail_since']>(defined('TIME') ? constant('TIME') : null))))) {?><span class="ty-qty-out-of-stock ty-control-group__item" id="out_of_stock_info_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
if (!$_smarty_tpl->tpl_vars['auth']->value['user_id']) {?><div class="ty-control-group ty-input-append ty-product-notify-email <?php if ($_smarty_tpl->tpl_vars['product_notification_enabled']->value!=smarty_modifier_enum("YesNo::YES")) {?>hidden<?php }?>" id="product_notify_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_features")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_features"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['show_features']->value&&$_smarty_tpl->tpl_vars['product']->value['abt__ut2_features']) {?>
        <?php $_smarty_tpl->tpl_vars['max_features'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['settings']->value['abt__ut2']['product_list']['max_features'][$_smarty_tpl->tpl_vars['settings']->value['abt__device']])===null||$tmp==='' ? 5 : $tmp), null, 0);?>
        <div class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("clean_price_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['show_price_values']->value&&$_smarty_tpl->tpl_vars['show_clean_price']->value&&$_smarty_tpl->tpl_vars['settings']->value['Appearance']['show_prices_taxed_clean']==smarty_modifier_enum("YesNo::YES")&&$_smarty_tpl->tpl_vars['product']->value['taxed_price']) {?>
        <span class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
$_tmp36=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp36." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%</em>", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp37=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp37." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%</em>", null, 0);?>
                <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['show_product_amount']->value&&$_smarty_tpl->tpl_vars['product']->value['is_edp']!=smarty_modifier_enum("YesNo::YES")&&$_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']!==smarty_modifier_enum("YesNo::NO")) {?>
    <div class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
&nbsp;<?php echo $_smarty_tpl->__("items");?>
                                    ...
                                    <?php } else { ?>
                                    	<span class="on_backorder"><i class="ut2-icon-notifications_none"></i><?php echo $_smarty_tpl->__("on_backorder");?>
</span>
                                    <?php }?>
                                </span>
                            </div>
                        <?php } elseif ($_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']!==smarty_modifier_enum("YesNo::NO")&&$_smarty_tpl->tpl_vars['settings']->value['General']['allow_negative_amount']!=smarty_modifier_enum("YesNo::YES")) {?>
...
">
                            <?php if ($_smarty_tpl->tpl_vars['product_amount']->value>0) {?>
                                <i class="ut2-icon-outline-check-circle"></i><?php echo $_smarty_tpl->__("in_stock");?>
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['settings']->value['abt__ut2']['product_list'][$_smarty_tpl->tpl_vars['tmpl']->value]['show_amount'][$_smarty_tpl->tpl_vars['settings']->value['abt__device']]==smarty_modifier_enum("YesNo::YES")&&($_smarty_tpl->tpl_vars['product_amount']->value<=0||$_smarty_tpl->tpl_vars['product_amount']->value<$_smarty_tpl->tpl_vars['product']->value['min_qty'])&&$_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']!==smarty_modifier_enum("YesNo::NO")&&$_smarty_tpl->tpl_vars['settings']->value['General']['allow_negative_amount']!=smarty_modifier_enum("YesNo::YES")||$_smarty_tpl->tpl_vars['details_page']->value||$_smarty_tpl->tpl_vars['product']->value['variation_features_variants']) {?>
                    <div class="ty-control-group product-list-field">
                        <?php if ($_smarty_tpl->tpl_vars['show_amount_label']->value) {?>
                            <label class="ty-control-group__label"><?php echo $_smarty_tpl->__("availability");?>
:</label>
...
" />
        ...
        <?php if ($_smarty_tpl->tpl_vars['show_qty']->value&&$_smarty_tpl->tpl_vars['product']->value['is_edp']!==smarty_modifier_enum("YesNo::YES")&&$_smarty_tpl->tpl_vars['cart_button_exists']->value==true&&($_smarty_tpl->tpl_vars['settings']->value['Checkout']['allow_anonymous_shopping']=="allow_shopping"||$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&$_smarty_tpl->tpl_vars['product']->value['avail_since']<=(defined('TIME') ? constant('TIME') : null)||($_smarty_tpl->tpl_vars['product']->value['avail_since']>(defined('TIME') ? constant('TIME') : null)&&$_smarty_tpl->tpl_vars['product']->value['out_of_stock_actions']==smarty_modifier_enum("OutOfStockActions::BUY_IN_ADVANCE"))) {?>
            <div class="ty-qty clearfix<?php if ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['quantity_changer']==smarty_modifier_enum("YesNo::YES")) {?> changer<?php }?>" id="qty_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
">
...
:</label><?php }?>
                ...
                <select name="product_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
...
.</p>
        <input type="hidden" name="product_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
][is_edp]" value="<?php echo htmlspecialchars(smarty_modifier_enum("YesNo::YES"), ENT_QUOTES, 'UTF-8');?>
" />
    <?php }?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("capture_product_labels_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_discount_label']->value&&($_smarty_tpl->tpl_vars['product']->value['discount_prc']||$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])&&$_smarty_tpl->tpl_vars['show_price_values']->value) {?>
                <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp38=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp38." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%</em>", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp39=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp39." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%</em>", null, 0);?>
                <?php }?>
