<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 11:04:54
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/blocks/list_templates/small_items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1081893729610e3ea689f3c1-91059901%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2346ee0411f5b12df0f2ccf29a50a2a3a649ddb' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/blocks/list_templates/small_items.tpl',
      1 => 1627896562,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1081893729610e3ea689f3c1-91059901',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e3ea69013e6_88994195',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e3ea69013e6_88994195')) {function content_610e3ea69013e6_88994195($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/block.hook.php';
...
$_smarty_tpl->tpl_vars["show_price"] = new Smarty_variable(true, null, 0);?>
...
"><?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('image_width'=>"50",'image_height'=>"50",'images'=>$_smarty_tpl->tpl_vars['product']->value['main_pair'],'obj_id'=>$_smarty_tpl->tpl_vars['obj_id_prefix']->value,'no_ids'=>true,'lazy_load'=>true), 0);?>
</a>
            </div>
            <div class="ty-template-small__item-description">
                <?php if ($_smarty_tpl->tpl_vars['block']->value['properties']['item_number']==smarty_modifier_enum("YesNo::YES")) {?><span class="ut2-hit"><?php echo htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['iteration'], ENT_QUOTES, 'UTF-8');?>
</span><?php }?>
				...
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_rating")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_rating"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                	<div class="ty-template-small__rating ut2-rating-stars">

                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:dotd_product_label")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:dotd_product_label"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:dotd_product_label"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                        ...
                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:video_gallery")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:video_gallery"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:video_gallery"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['settings']->value['abt__ut2']['product_list']['show_rating']==smarty_modifier_enum("YesNo::YES")&&$_smarty_tpl->tpl_vars['addons']->value['product_reviews']['status']==smarty_modifier_enum("ObjectStatuses::ACTIVE")) {?>
                            <?php if ($_smarty_tpl->tpl_vars['product']->value['product_reviews_count']) {?><div class="cn-reviews">(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_reviews_count'], ENT_QUOTES, 'UTF-8');?>
)</div><?php }?>
                        ...
                        <?php } else { ?>
                            ...
                            <?php if (strlen(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['rating']->value])>40&&$_smarty_tpl->tpl_vars['product']->value['discussion_type']&&$_smarty_tpl->tpl_vars['product']->value['discussion_type']!="D") {?>
                                <?php echo Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['rating']->value];?>

                            <?php } elseif ($_smarty_tpl->tpl_vars['addons']->value['discussion']['status']==smarty_modifier_enum("ObjectStatuses::ACTIVE")) {?>
                                 <span class="ty-nowrap ty-stars"><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i></span>
                            <?php }?>
                        <?php }?>
                    </div>
				<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:product_rating"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                
                <?php if ($_smarty_tpl->tpl_vars['show_price']->value) {?>
                <div class="ty-template-small__item-price pr-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['abt__ut2']['product_list']['price_display_format'], ENT_QUOTES, 'UTF-8');
