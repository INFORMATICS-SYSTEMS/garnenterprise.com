<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 09:58:18
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_stars.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1830837997610e2f0a4a86d6-66775217%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c6794ab6e80e19fed0c539771b050f3a980dda92' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_stars.tpl',
      1 => 1627581750,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1830837997610e2f0a4a86d6-66775217',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e2f0a4e0f53_59580330',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e2f0a4e0f53_59580330')) {function content_610e2f0a4e0f53_59580330($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
$_tmp44=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['title']->value).". ".$_tmp44.".", null, 0);?>
    <?php } elseif ($_smarty_tpl->tpl_vars['button']->value) {?>
        <?php ob_start();
echo $_smarty_tpl->__("product_reviews.click_to_see_reviews");
$_tmp45=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['title']->value).". ".$_tmp45.".", null, 0);?>
    <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['rating']->value>0) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['link']->value) {?>
        <?php ob_start();
echo $_smarty_tpl->__("product_reviews.show_rating");
$_tmp46=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['title']->value).". ".$_tmp46.".", null, 0);?>
    <?php } elseif ($_smarty_tpl->tpl_vars['button']->value) {?>
        <?php ob_start();
echo $_smarty_tpl->__("product_reviews.click_to_see_reviews");
$_tmp47=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['title']->value).". ".$_tmp47.".", null, 0);?>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['link']->value===true) {?>
        <?php $_smarty_tpl->tpl_vars['link'] = new Smarty_variable("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])."&selected_section=product_reviews#product_reviews", null, 0);?>
    <?php }?>
