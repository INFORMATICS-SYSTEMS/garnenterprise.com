<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 09:58:21
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/scripts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:519057471610e2f0df25970-95004270%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02cf420a2a96a384dfd17cd1a81a96b56f6b48f1' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/scripts.tpl',
      1 => 1627896562,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '519057471610e2f0df25970-95004270',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e2f0e08ed40_13650357',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e2f0e08ed40_13650357')) {function content_610e2f0e08ed40_13650357($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_scripts')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/block.scripts.php';
...
ob_start();
echo htmlspecialchars(fn_abt__ut2_get_jquery_version("main"), ENT_QUOTES, 'UTF-8');
$_tmp54=ob_get_clean();?><?php echo smarty_function_script(array('src'=>"js/lib/jquery/jquery-".$_tmp54.".min.js",'no-defer'=>true),$_smarty_tpl);?>

<?php ob_start();
echo htmlspecialchars(fn_abt__ut2_get_jquery_version("migrate"), ENT_QUOTES, 'UTF-8');
$_tmp55=ob_get_clean();?><?php echo smarty_function_script(array('src'=>"js/lib/jquery/jquery-migrate-".$_tmp55.".min.js",'no-defer'=>true),$_smarty_tpl);?>
...
ob_start();
echo htmlspecialchars(fn_abt__ut2_get_jquery_version("main"), ENT_QUOTES, 'UTF-8');
$_tmp56=ob_get_clean();?><?php echo smarty_function_script(array('src'=>"js/lib/jquery/jquery-".$_tmp56.".min.js",'no-defer'=>true),$_smarty_tpl);?>

<?php ob_start();
echo htmlspecialchars(fn_abt__ut2_get_jquery_version("migrate"), ENT_QUOTES, 'UTF-8');
$_tmp57=ob_get_clean();?><?php echo smarty_function_script(array('src'=>"js/lib/jquery/jquery-migrate-".$_tmp57.".min.js",'no-defer'=>true),$_smarty_tpl);?>
