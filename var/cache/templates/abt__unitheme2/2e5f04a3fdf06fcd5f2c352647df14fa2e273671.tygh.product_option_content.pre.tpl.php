<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 10:14:26
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/addons/product_variations/hooks/products/product_option_content.pre.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1724994226610e32d29b3733-23815627%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2e5f04a3fdf06fcd5f2c352647df14fa2e273671' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/addons/product_variations/hooks/products/product_option_content.pre.tpl',
      1 => 1627896589,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1724994226610e32d29b3733-23815627',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e32d2a4a3a9_08440137',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e32d2a4a3a9_08440137')) {function content_610e32d2a4a3a9_08440137($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/function.script.php';
...
if ($_smarty_tpl->tpl_vars['feature']->value['suffix']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['suffix'], ENT_QUOTES, 'UTF-8');
}?></div>
                                    </div>
                                <?php }?>
                            <?php } ?>
...
"
                                   class="ty-product-options__image--wrapper cm-tooltip <?php if ($_smarty_tpl->tpl_vars['variant']->value['variant_id']==$_smarty_tpl->tpl_vars['feature']->value['variant_id']) {?>ty-product-options__image--wrapper--active<?php }?> <?php if ($_smarty_tpl->tpl_vars['feature']->value['purpose']===$_smarty_tpl->tpl_vars['purpose_create_variations']->value||$_smarty_tpl->tpl_vars['quick_view']->value) {?>cm-ajax cm-ajax-cache<?php }?>" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['prefix'], ENT_QUOTES, 'UTF-8');?>
