<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 09:58:16
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/blocks/cart_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2135028618610e2f08156191-21464658%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b37d8a5a28cf6b408301c3244e01039df566152' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/blocks/cart_content.tpl',
      1 => 1627896562,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2135028618610e2f08156191-21464658',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e2f081b48c7_69867774',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e2f081b48c7_69867774')) {function content_610e2f081b48c7_69867774($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('cart','cart','cart_is_empty','total_items','items','for','view_cart','checkout','cart','cart','cart_is_empty','total_items','items','for','view_cart','checkout'));
?>
...
" class="cm-popup-box ty-dropdown-box__content ty-dropdown-box__content--cart hidden">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:minicart")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:minicart"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <div class="cm-cart-content <?php if ($_smarty_tpl->tpl_vars['block']->value['properties']['products_links_type']=="thumb") {?>cm-cart-content-thumb<?php }?> <?php if ($_smarty_tpl->tpl_vars['block']->value['properties']['display_delete_icons']==smarty_modifier_enum("YesNo::YES")) {?>cm-cart-content-delete<?php }?>">
                                                ...
                                                <li class="ty-cart-items__list-item">
                                                    ...
                                                    <?php if ($_smarty_tpl->tpl_vars['block']->value['properties']['products_links_type']=="thumb") {?>
                                                        <div class="ty-cart-items__list-item-image">
                                                            <?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('image_width'=>"40",'image_height'=>"40",'images'=>$_smarty_tpl->tpl_vars['product']->value['main_pair'],'no_ids'=>true,'lazy_load'=>false), 0);?>
...
"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['product']->value['product'])===null||$tmp==='' ? fn_get_product_name($_smarty_tpl->tpl_vars['product']->value['product_id']) : $tmp);?>
                            ...
                            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:cart_subtotal")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:cart_subtotal"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                            <?php if ($_SESSION['cart']['amount']>1||$_smarty_tpl->tpl_vars['product']->value['extra']['buy_together']) {?>
                            <p class="b-top"><?php echo $_smarty_tpl->__("total_items");?>
:&nbsp;<span class="ty-float-right"><?php echo htmlspecialchars($_SESSION['cart']['amount'], ENT_QUOTES, 'UTF-8');?>
&nbsp;<?php echo $_smarty_tpl->__("items");?>
 <?php echo $_smarty_tpl->__("for");?>
&nbsp;&nbsp;<strong><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_SESSION['cart']['display_subtotal']), 0);?>
</strong></span><br>&nbsp;</p>
                            <?php }?>
                            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:cart_subtotal"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
