<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 09:58:20
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/scroller_init.tpl" */ ?>
<?php /*%%SmartyHeaderCode:262678836610e2f0c53f402-45601678%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b66a338ce3a05091ba333622da949033b3de29df' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/scroller_init.tpl',
      1 => 1627896562,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '262678836610e2f0c53f402-45601678',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e2f0c568a67_33085476',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e2f0c568a67_33085476')) {function content_610e2f0c568a67_33085476($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/vhosts/garnenterprise.com/httpdocs/app/functions/smarty_plugins/function.script.php';
...
,
                ...
                itemsDesktopSmall = 4;
                itemsTablet = 4;
                itemsTabletSmall = <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['itemsTabletSmall']->value)===null||$tmp==='' ? 2 : $tmp), ENT_QUOTES, 'UTF-8');?>
;
                itemsMobile = 1;

            if (item > 3) {
                itemsDesktop = item;
                itemsDesktopSmall = item - <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['itemsDesktopSmall']->value)===null||$tmp==='' ? 1 : $tmp), ENT_QUOTES, 'UTF-8');?>
;
                itemsTablet = item - <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['itemsTablet']->value)===null||$tmp==='' ? 2 : $tmp), ENT_QUOTES, 'UTF-8');?>
;
            } else if (item == 1) {
