<?php /* Smarty version Smarty-3.1.21, created on 2021-08-07 10:47:30
         compiled from "/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1089640578610e3a92821355-69663228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '523840af7b7b4cf6333c1c56ee315868174f77b5' => 
    array (
      0 => '/var/www/vhosts/garnenterprise.com/httpdocs/design/themes/abt__unitheme2/templates/common/pagination.tpl',
      1 => 1627896562,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1089640578610e3a92821355-69663228',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_610e3a9284ef51_18028065',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610e3a9284ef51_18028065')) {function content_610e3a9284ef51_18028065($_smarty_tpl) {?><?php
...
<?php if ($_smarty_tpl->tpl_vars['pagination']->value['total_pages']>1) {?>
    ...
    <?php }?>
    <div class="ty-pagination" id="ut2_pagination_block<?php if (Smarty::$_smarty_vars['capture']['pagination_open']=="Y") {?>_bottom<?php }?>">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination']->value['next_range_from'], ENT_QUOTES, 'UTF-8');?>
 - <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination']->value['next_range_to'], ENT_QUOTES, 'UTF-8');?>
        ...
        <?php }?>
    <!--ut2_pagination_block<?php if (Smarty::$_smarty_vars['capture']['pagination_open']=="Y") {?>_bottom<?php }?>--></div>
    <?php if (Smarty::$_smarty_vars['capture']['pagination_open']=="Y") {?>
        </div>
    <?php }?>
    <?php } else { ?>
